...
$response = $client->request('GET', 'https://firestore.googleapis.com/v1/projects/virta-apps/databases/(default)/documents/users/TkZbhYD1sQaBXOtBi7fPzC2rr1p1/histories/' . $id . '');

$body = $response->getBody();

$result = json_decode($body->getContents(), TRUE)['fields'];
?>
              ...
              <div class="card-body table-responsive p-0" style="height: 300px;">
                ...
                <table class="table table-head-fixed text-nowrap">
                  ...
                  <tbody>
                    <tr>
                    <td><?php echo 1; ?></td>
                    <td><?= $result['name']['stringValue'] ?></td>
                    <td><?= $result['tangan']['stringValue'] ?></td>
                    <td><?= $result['bahu']['stringValue'] ?></td>
                    <td><?= $result['type']['stringValue'] ?></td>
                    <td><?= $result['ukuran']['stringValue'] ?></td>
                    <td><?= $result['badan']['stringValue'] ?></td>
                    <td><?= $result['address']['stringValue'] ?></td>
                    <td><?= $result['gambar']['stringValue'] ?></td>
                    </tr>
                  </tbody>
                </table>
